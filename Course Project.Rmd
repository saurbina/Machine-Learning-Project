...
In conclusion, it is appreciated that the accuracy of the random forest methos its better than the other two. This method have an accuracy of ` r accuracy1[1]` and an out sample of  `r out.sample[1]`. 
